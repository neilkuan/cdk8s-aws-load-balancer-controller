...
export const awsLoadBalancerControllerPolicyV1 = {
  actions: [
...
export const awsLoadBalancerControllerPolicyV2 = [
  {
    Effect: 'Allow',
    Action: [
      'iam:CreateServiceLinkedRole',
...
export class AwsLoadBalancePolicy {
  public static addPolicy(version: string, role: any) :void {
    if (version == 'v1') {
      role.addToPrincipalPolicy(new iam.PolicyStatement( awsLoadBalancerControllerPolicyV1 ));
    } else if (version == 'v2') {
